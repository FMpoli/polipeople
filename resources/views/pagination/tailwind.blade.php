                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-gray-200 bg-gray-900 border border-gray-300 cursor-default dark:bg-gray-800 dark:border-gray-600">{{ $page }}</span>
                                    </span>
                                @else
